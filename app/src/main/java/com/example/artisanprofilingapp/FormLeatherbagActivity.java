...
public class FormLeatherbagActivity extends AppCompatActivity {
    ...
    int potaka=0;
    String productFlag = "8";//Leather Bag

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_form_leatherbag);
...
//        nam5 = findViewById(R.id.nam5);
        ...
        requestQueue = Volley.newRequestQueue(FormLeatherbagActivity.this);
        progressDialog = new ProgressDialog(FormLeatherbagActivity.this);
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    Intent i=new Intent(FormLeatherbagActivity.this,AudioActivity.class);
                    startActivity(i);

                }
                else{
                    Intent intent = new Intent(FormLeatherbagActivity.this, InternetCheckActivity.class);
...
//                    }
                    ...
                    if (potaka==5){
                        ...
                        Toast.makeText(FormLeatherbagActivity.this,"সব ফিল্ড টাইপ করুন",Toast.LENGTH_LONG).show();
                    }
...
//                        +"&id="+ idToGet+ "&addressExp="+ AddressExpHolder + "&age="+ ageToGet;
                ...
                String myurl = "https://artisanapp.xyz/productDescriptionForm.php?productname="+ DataHolder3
                        +"&measurement="+ DataHolder4 +"&material="+ DataHolder5 +"&artworktype="+ DataHolder6
                        + "&bagtype=" + DataHolder8+ "&artisanid="+ idToGet+
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET, myurl,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String ServerResponse) {
                                ...
                                Toast.makeText(FormLeatherbagActivity.this, ServerResponse, Toast.LENGTH_LONG).show();
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError volleyError) {
                                ...
                                Toast.makeText(FormLeatherbagActivity.this, volleyError.toString(), Toast.LENGTH_LONG).show();
