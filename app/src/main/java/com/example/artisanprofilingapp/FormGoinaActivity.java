...
public class FormGoinaActivity extends AppCompatActivity {
    ...
    int potaka=0;
    String productFlag = "2";//goina

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_form_goina);
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    Intent i=new Intent(FormGoinaActivity.this,AudioActivity.class);
                    startActivity(i);

                }
                else{
                    Intent intent = new Intent(FormGoinaActivity.this, InternetCheckActivity.class);
...
//                    startActivity(i);
                    ...
                    if (potaka==6){
                        ...
                        Toast.makeText(FormGoinaActivity.this,"সব ফিল্ড টাইপ করুন",Toast.LENGTH_LONG).show();
                    }
...
//                        +"&id="+ idToGet+ "&addressExp="+ AddressExpHolder + "&age="+ ageToGet;
                ...
                String myurl = "https://artisanapp.xyz/productDescriptionForm.php?productname="+ DataHolder3
                        +"&material="+ DataHolder4 +"&length="+ DataHolder5 +"&pendentMeasurement="+ DataHolder6
                        +"&earringmeasurement="+ DataHolder7+ "&artworktype=" + DataHolder8+ "&artisanid="+ idToGet+
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET, myurl,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String ServerResponse) {
                                ...
                                Toast.makeText(FormGoinaActivity.this, ServerResponse, Toast.LENGTH_LONG).show();
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError volleyError) {
                                ...
                                Toast.makeText(FormGoinaActivity.this, volleyError.toString(), Toast.LENGTH_LONG).show();
