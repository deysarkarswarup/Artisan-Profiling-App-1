...
public class FormTshirtActivity extends AppCompatActivity {
    ...
    int potaka=0;
    String productFlag = "4";//T-Shirt

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_form_tshirt);
...
//        nam5 = findViewById(R.id.nam5);
        ...
        requestQueue = Volley.newRequestQueue(FormTshirtActivity.this);
        progressDialog = new ProgressDialog(FormTshirtActivity.this);
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    Intent i=new Intent(FormTshirtActivity.this,AudioActivity.class);
                    startActivity(i);

                }
                else{
                    Intent intent = new Intent(FormTshirtActivity.this, InternetCheckActivity.class);
...
//                    }
                    ...
                    if (potaka==5){
                        ...
                        Toast.makeText(FormTshirtActivity.this,"সব ফিল্ড টাইপ করুন",Toast.LENGTH_LONG).show();
                    }
...
//                        +"&id="+ idToGet+ "&addressExp="+ AddressExpHolder + "&age="+ ageToGet;
                ...
                String myurl = "https://artisanapp.xyz/productDescriptionForm.php?productname="+ DataHolder3
                        +"&material="+ DataHolder4 +"&availablesize="+ DataHolder5 +"&paintmaterial="+ DataHolder6
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET, myurl,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String ServerResponse) {
                                ...
                                Toast.makeText(FormTshirtActivity.this, ServerResponse, Toast.LENGTH_LONG).show();
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError volleyError) {
                                ...
                                Toast.makeText(FormTshirtActivity.this, volleyError.toString(), Toast.LENGTH_LONG).show();
