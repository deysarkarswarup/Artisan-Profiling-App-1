...
public class FormUtilityActivity extends AppCompatActivity {
    ...
    int potaka=0;
    String productFlag = "12";//T-Shirt

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_form_utility);
...
//        nam6 = findViewById(R.id.nam6);
        ...
        requestQueue = Volley.newRequestQueue(FormUtilityActivity.this);
        progressDialog = new ProgressDialog(FormUtilityActivity.this);
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    Intent i=new Intent(FormUtilityActivity.this,AudioActivity.class);
                    startActivity(i);

                }
                else{
                    Intent intent = new Intent(FormUtilityActivity.this, InternetCheckActivity.class);
...
//                    }
                    ...
                    if (potaka==4){
                        ...
                        Toast.makeText(FormUtilityActivity.this,"সব ফিল্ড টাইপ করুন",Toast.LENGTH_LONG).show();
                    }
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET, myurl,
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError volleyError) {
                                ...
                                Toast.makeText(FormUtilityActivity.this, volleyError.toString(), Toast.LENGTH_LONG).show();
