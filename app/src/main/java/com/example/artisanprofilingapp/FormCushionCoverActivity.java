...
public class FormCushionCoverActivity extends AppCompatActivity {
    ...
    int potaka=0;
    String productFlag = "7";//Cushion Cover

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_form_cushion_cover);
...
//        nam5 = findViewById(R.id.nam5);
        ...
        requestQueue = Volley.newRequestQueue(FormCushionCoverActivity.this);
        progressDialog = new ProgressDialog(FormCushionCoverActivity.this);
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    Intent i=new Intent(FormCushionCoverActivity.this,AudioActivity.class);
                    startActivity(i);

                }
                else{
                    Intent intent = new Intent(FormCushionCoverActivity.this, InternetCheckActivity.class);
...
//                    }
                    ...
                    if (potaka==5){
                        ...
                        Toast.makeText(FormCushionCoverActivity.this,"সব ফিল্ড টাইপ করুন",Toast.LENGTH_LONG).show();
                    }
...
//                        +"&id="+ idToGet+ "&addressExp="+ AddressExpHolder + "&age="+ ageToGet;
                ...
                String myurl = "https://artisanapp.xyz/productDescriptionForm.php?productname="+ DataHolder3
                        +"&material="+ DataHolder4 +"&measurement="+ DataHolder5 +"&artworktype="+ DataHolder6
                        + "&closuretype=" + DataHolder8+ "&artisanid="+ idToGet+
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET, myurl,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String ServerResponse) {
                                ...
                                Toast.makeText(FormCushionCoverActivity.this, ServerResponse, Toast.LENGTH_LONG).show();
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError volleyError) {
                                ...
                                Toast.makeText(FormCushionCoverActivity.this, volleyError.toString(), Toast.LENGTH_LONG).show();
