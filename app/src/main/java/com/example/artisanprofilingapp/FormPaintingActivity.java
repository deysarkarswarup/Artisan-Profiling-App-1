...
public class FormPaintingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_painting);
...
//        nam5 = findViewById(R.id.nam5);
        ...
        requestQueue = Volley.newRequestQueue(FormPaintingActivity.this);
        progressDialog = new ProgressDialog(FormPaintingActivity.this);
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    Intent i=new Intent(FormPaintingActivity.this,AudioActivity.class);
                    startActivity(i);

                }
                else{
                    Intent intent = new Intent(FormPaintingActivity.this, InternetCheckActivity.class);
...
//                    }
                    ...
                    if (potaka==5){
                        ...
                        Toast.makeText(FormPaintingActivity.this,"সব ফিল্ড টাইপ করুন",Toast.LENGTH_LONG).show();
                    }
...
//                        +"&id="+ idToGet+ "&addressExp="+ AddressExpHolder + "&age="+ ageToGet;
                ...
                String myurl = "https://artisanapp.xyz/productDescriptionForm.php?productname="+ DataHolder3
                        +"&medium="+ DataHolder4 +"&dimension="+ DataHolder5 +"&surface="+ DataHolder6
                        + "&theme=" + DataHolder8+ "&artisanid="+ idToGet+
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET, myurl,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String ServerResponse) {
                                ...
                                Toast.makeText(FormPaintingActivity.this, ServerResponse, Toast.LENGTH_LONG).show();
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError volleyError) {
                                ...
                                Toast.makeText(FormPaintingActivity.this, volleyError.toString(), Toast.LENGTH_LONG).show();
