...
public class FormBlousepieceActivity extends AppCompatActivity {
    ...
    int potaka=0;
    String productFlag = "9";//Blouse Piece

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_form_blousepiece);
...
//        nam6 = findViewById(R.id.nam6);
        ...
        requestQueue = Volley.newRequestQueue(FormBlousepieceActivity.this);
        progressDialog = new ProgressDialog(FormBlousepieceActivity.this);
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    Intent i=new Intent(FormBlousepieceActivity.this,AudioActivity.class);
                    startActivity(i);

                }
                else{
                    Intent intent = new Intent(FormBlousepieceActivity.this, InternetCheckActivity.class);
...
//                    }
                    ...
                    if (potaka==4){
                        ...
                        Toast.makeText(FormBlousepieceActivity.this,"সব ফিল্ড টাইপ করুন",Toast.LENGTH_LONG).show();
                    }
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET, myurl,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String ServerResponse) {
                                ...
                                Toast.makeText(FormBlousepieceActivity.this, ServerResponse, Toast.LENGTH_LONG).show();
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError volleyError) {
                                ...
                                Toast.makeText(FormBlousepieceActivity.this, volleyError.toString(), Toast.LENGTH_LONG).show();
