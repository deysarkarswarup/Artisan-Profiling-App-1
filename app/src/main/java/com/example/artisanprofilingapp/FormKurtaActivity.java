...
public class FormKurtaActivity extends AppCompatActivity {
    ...
    String DataHolder2, DataHolder3, DataHolder4, DataHolder5, DataHolder6, DataHolder7, DataHolder8, DataHolder9;
    SharedPreferences myPref;
    private MediaPlayer mediaPlayer;
    int potaka=0;
    String productFlag = "10";//Kurta Kurti

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_form_kurta);
...
//        productid = findViewById(R.id.productid);
        ...
        requestQueue = Volley.newRequestQueue(FormKurtaActivity.this);
        progressDialog = new ProgressDialog(FormKurtaActivity.this);
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    Intent i=new Intent(FormKurtaActivity.this,AudioActivity.class);
                    startActivity(i);

                }
                else{
                    Intent intent = new Intent(FormKurtaActivity.this, InternetCheckActivity.class);
...
//                    startActivity(i);
                    ...
                    if (!nam7.getText().toString().equals("")) {
                        potaka++;
                        //Toast.makeText(MainActivity.this,"হয়েগেছে",Toast.LENGTH_LONG).show();

                    } else {
                        nam7.setError("টাইপ করুন");
                    }
                    ...
                    if (potaka==7){
                        ...
                        Toast.makeText(FormKurtaActivity.this,"সব ফিল্ড টাইপ করুন",Toast.LENGTH_LONG).show();
                    }
...
//                DataHolder2 = DataHolder2.replaceAll(" ","%20");
                ...
                DataHolder9 = DataHolder8.replaceAll(" ","%20");
...
//                DataHolder2 = DataHolder2.replaceAll(characterFilter,"");
                ...
                DataHolder9 = DataHolder8.replaceAll(characterFilter,"");
...
//                        +"&id="+ idToGet+ "&addressExp="+ AddressExpHolder + "&age="+ ageToGet;
                ...
                String myurl = "https://artisanapp.xyz/productDescriptionForm.php?productname="+ DataHolder3
                        +"&availablesize="+ DataHolder4 +"&fabric="+ DataHolder5 +"&artwork="+ DataHolder6
                        +"&collartype="+ DataHolder7+ "&sleeve=" + DataHolder8+ "&measurements="+ DataHolder9 +"&artisanid="+ idToGet+
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET, myurl,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String ServerResponse) {
                                ...
                                Toast.makeText(FormKurtaActivity.this, ServerResponse, Toast.LENGTH_LONG).show();
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError volleyError) {
                                ...
                                Toast.makeText(FormKurtaActivity.this, volleyError.toString(), Toast.LENGTH_LONG).show();
