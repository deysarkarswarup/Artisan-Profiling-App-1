...
public class FormBagActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_bag);
...
//        productid = findViewById(R.id.productid);
        ...
        requestQueue = Volley.newRequestQueue(FormBagActivity.this);
        progressDialog = new ProgressDialog(FormBagActivity.this);
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    Intent i=new Intent(FormBagActivity.this,AudioActivity.class);
                    startActivity(i);

                }
                else{
                    Intent intent = new Intent(FormBagActivity.this, InternetCheckActivity.class);
...
//                    startActivity(i);
                    ...
                    if (potaka==6){
                        ...
                        Toast.makeText(FormBagActivity.this,"সব ফিল্ড টাইপ করুন",Toast.LENGTH_LONG).show();
                    }
...
//                        +"&id="+ idToGet+ "&addressExp="+ AddressExpHolder + "&age="+ ageToGet;
                ...
                String myurl = "https://artisanapp.xyz/productDescriptionForm.php?productname="+ DataHolder3
                        +"&material="+ DataHolder4 +"&productDimension="+ DataHolder5 +"&straptype="+ DataHolder6
                        +"&closuretype="+ DataHolder7+ "&artworktype=" + DataHolder8+ "&artisanid="+ idToGet+
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET, myurl,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String ServerResponse) {
                                ...
                                Toast.makeText(FormBagActivity.this, ServerResponse, Toast.LENGTH_LONG).show();
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError volleyError) {
                                ...
                                Toast.makeText(FormBagActivity.this, volleyError.toString(), Toast.LENGTH_LONG).show();
